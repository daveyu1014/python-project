...
output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]  #輸出圖形規格
classes = [line.strip() for line in open("data/coco.names")]  #分類標籤
colors = [(255,0,0), (0,255,0), (0,0,255), (127,0,255), (0,125,255)]  #框選顏色，目前只使用5種顏色框

img = cv2.imread("person.jpg")  #讀取圖片
...
for out in outs:  #21~36逐一處理偵測到物體的矩形座標
